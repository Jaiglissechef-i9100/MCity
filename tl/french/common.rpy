...
translate french strings:
    ...
    new "Êtes-vous sûr de vouloir effacer cette sauvegarde ?"
    ...
    new "Êtes-vous sûr de vouloir sauter les dialogues invisibles pour passer au choix suivant ?"

    # 00keymap.rpy:258
    old "Failed to save screenshot as %s."
    new "Échec de la sauvegarde du screenshot en tant que %s."

    # 00keymap.rpy:270
    old "Saved screenshot as %s."
    new "Sauvegarde du screenshot en tant que %s."

    # 00library.rpy:146
    old "Self-voicing disabled."
    new "Auto-élucidation désactivé."
