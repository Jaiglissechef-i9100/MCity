...
screen max_r_points_C_scr:
    ...
    if preferences.language == "french":
        ...
        if C_R_max_page == 1 and C_harem == True:
            add "images/game_gui/Max_R_Points/4b.png" xpos 667 ypos 328
        ...
        if C_pregnant == True and C_R_max_page == 2:
            ...
            add "images/game_gui/Max_R_Points/5.png" xpos 667 ypos 328
            add "images/game_gui/Max_R_Points/9.png" xpos 667 ypos 328
...
screen C_pregnant_info:
    zorder 109
    if preferences.language == "french":
        add "images/game_gui/Max_R_Points/8.png" xpos 1338 ypos 624

        vbox xpos 1443 ypos 704 spacing 20:
            text __("{color=#000000}Requirements:{/color}") size 33
