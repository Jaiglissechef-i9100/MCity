...
screen ML_NS_scr:
    ...
    $ y = 350
    $ i = 0
    $ sorted_nsb1 = sorted(nsb_box.ml_nsb_s, key=attrgetter('number'))
    ...
    if len(nsb_box.ml_nsb_s)>9:
        ...
        imagebutton:
            ...
            action [SetVariable('inv_page', prev_inv_page), Show("ML_NS_scr")]
        ...
        imagebutton:
            ...
            action [SetVariable('inv_page', next_inv_page), Show("ML_NS_scr")]
            hovered Play ("sound", "sfx/click2.wav")
    imagebutton:
        xpos 191
        ypos 902
        ...
        action [SetVariable("inv_page", 0),Hide("ML_NS_scr"), Jump("ML_NS_back")]
        hovered Play ("sound", "sfx/click2.wav")
