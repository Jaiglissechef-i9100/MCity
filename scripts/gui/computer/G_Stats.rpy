...
screen G_Stats_scr:
    ...
    imagebutton:
        ...
        action [Play ("sound", "sfx/mouse_click.mp3"),Hide("displayTextScreen"),Hide("G_Stats_scr"),Jump("pc_icon_label")]
    if g_stats_page_char > 1:
        textbutton "Previous":
            action SetVariable("g_stats_page_char", g_stats_page_char - 1)
            xalign 0.25
            yalign 0.8
