...
label gallery_label:
    ...
    if SR3_rep_v71 == True:
        $ scenes_gallery_photos.add1("img63_SR3_we_bath_rep")
        $ scenes_gallery_photos.add1("img64_SR3_we_home_end_bed_rep")
        $ scenes_gallery_photos.add1("img65_SR3_we_home_end_couch_rep")
        $ scenes_gallery_photos.add1("img66_SR3_home_end_penetrate_rep")
        $ SR3_rep_v71 = False
