    ...
    if sms8_sara == True and day_time == 1:
        if preferences.language == "french":
            ...
            if not sms_Sara15 in sms_box.sms_s:
                timer 0.001 action [SetVariable("Sara_unread_alert", False),Play("sound", "sfx/phone_vibrate.mp3"), addSms(sms_Sara15_french),addSms(sms_Sara16),addSms(sms_Sara17_french),addSms(sms_Sara18_french),addSms(sms_Sara19),addSms(sms_Sara20_french),addSms(sms_Sara21_french),Show("new_message_incoming1_NC")]
    ...
    if Ce_sms1 == True and day_time == 4:
        if preferences.language == "french":
            ...
            if not sms_Celia1 in sms_box.sms_s:
                ...
                timer 0.003 action [SetVariable("Celia_unread_alert", False),Play("sound", "sfx/phone_vibrate.mp3"), addSms(sms_Celia1),addSms(sms_Celia2_french),Show("new_message_incoming1_NC")]
    ...
    if Ce_sms2 == True and day_time == 2:
        if preferences.language == "french":
            ...
            if not sms_Celia4 in sms_box.sms_s:
                ...
                timer 0.003 action [SetVariable("Celia_unread_alert", False),Play("sound", "sfx/phone_vibrate.mp3"), addSms(sms_Celia4_french),Show("new_message_incoming1_NC")]
    ...
    if Ce_sms3 == 3:
        if preferences.language == "french":
            ...
            if not sms_Celia5 in sms_box.sms_s:
                ...
                timer 0.003 action [SetVariable("Celia_unread_alert", False),Play("sound", "sfx/phone_vibrate.mp3"),addSms(sms_Celia5),addSms(sms_Celia6_french),Show("new_message_incoming1_NC"),]
    ...
    if Ce_sms4 == True and day_time == 1:
        if preferences.language == "french":
            ...
            if not sms_Celia3 in sms_box.sms_s:
                ...
                timer 0.003 action [SetVariable("Celia_unread_alert", False),Play("sound", "sfx/phone_vibrate.mp3"), addSms(sms_Celia3),addSms(sms_Celia7_french),Show("new_message_incoming1_NC")]
