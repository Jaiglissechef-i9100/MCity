    ...
    if not "img30_sec_card" in gallery_photos.storage:
        if jack_frost == False:
            imagebutton:
                ...
                ypos 884
                focus_mask True
                idle "images/secret_gallery/Bonus/B30b.png"
                hover "images/secret_gallery/Bonus/B30b_hover.png"
                if clickable == True:
    ...
    if not "img31_sec_card" in gallery_photos.storage:
        if jack_frost == False:
            imagebutton:
                ...
                ypos 212
                focus_mask True
                idle "images/secret_gallery/Bonus/B31b.png"
                hover "images/secret_gallery/Bonus/B31b_hover.png"
                if clickable == True:
                    hovered Show("displayTextScreen", displayText = __("Secret Photo"))
