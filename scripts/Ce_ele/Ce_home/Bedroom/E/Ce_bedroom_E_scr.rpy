screen Ce_bedroom_E_scr:
    ...
    if not "img54_sec_card" in gallery_photos.storage:
        if jack_frost == False:
            imagebutton:
                ...
                ypos 566
                focus_mask True
                idle "images/secret_gallery/Bonus/B54b.png"
                hover "images/secret_gallery/Bonus/B54b_hover.png"
                if clickable == True:
                    hovered Show("displayTextScreen", displayText = __("Secret Photo"))
    ...
    imagebutton:
        ...
        ypos 167
        focus_mask True
        idle "/images/Ce_ele/Ce_home/Bedroom/E/B1.png"
        hover "/images/Ce_ele/Ce_home/Bedroom/E/B1_hover.png"
        if clickable == True:
