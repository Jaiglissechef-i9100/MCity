    ...
    if not "img80_sec_card" in gallery_photos.storage:
        if jack_frost == False:
            imagebutton:
                ...
                ypos 420
                focus_mask True
                idle "images/secret_gallery/Bonus/B80b.png"
                hover "images/secret_gallery/Bonus/B80b_hover.png"
                if clickable == True:
    ...
    if not "img81_sec_card" in gallery_photos.storage:
        if jack_frost == False:
            imagebutton:
                ...
                ypos 349
                focus_mask True
                idle "images/secret_gallery/Bonus/B81b.png"
                hover "images/secret_gallery/Bonus/B81b_hover.png"
                if clickable == True:
                    hovered Show("displayTextScreen", displayText = __("Secret Photo"))
