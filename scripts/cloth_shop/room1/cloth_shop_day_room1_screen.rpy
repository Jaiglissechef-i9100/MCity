...
screen cloth_shop_robber_screen:
    ...
    if Caroline_points == 4 and CR4_AS1 == True:
        imagebutton:
            xpos 868
            ypos 261
            focus_mask True
            idle "images/cloth_shop/room1/day/CR4_AS1_B6.png"
            hover "images/cloth_shop/room1/day/CR4_AS1_B6_hover.png"
            if clickable == True:
                action [Hide("displayTextScreen"),Jump("CR4_AS1_label")]
                hovered Show("displayTextScreen", displayText = "Caroline")
                unhovered Hide("displayTextScreen")

    if Caroline_points == 4 and CR4_AS2 == 1:
        imagebutton:
            xpos 731
            ypos 256
            focus_mask True
            idle "images/cloth_shop/room1/day/CR4_AS2.png"
    ...
    if Caroline_points == 4 and CR4_AS3 > 1 and CR4_AS3 < 6:
        imagebutton:
            xpos 867
            ypos 262
            focus_mask True
            idle "images/cloth_shop/room1/day/CR4_AS3.png"
            hover "images/cloth_shop/room1/day/CR4_AS3_hover.png"
            if clickable == True:
                action [Hide("displayTextScreen"),Jump("CR4_AS3_label")]
                hovered Show("displayTextScreen", displayText = "Caroline")
                unhovered Hide("displayTextScreen")

    if Caroline_points == 4 and CR4_AS3 > 5:
        imagebutton:
            xpos 891
            ypos 262
            focus_mask True
            idle "images/cloth_shop/room1/day/CR4_AS3_2.png"
            hover "images/cloth_shop/room1/day/CR4_AS3_2_hover.png"
            if clickable == True:
